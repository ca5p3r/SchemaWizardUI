...
export const requester = async (
  ...
  if (enable_compare) {
    ...
    data.append(
      "src_dbname",
      connection_object.src.dbname ? connection_object.src.dbname : "postgres"
    );
    ...
    data.append(
      "dest_dbname",
      connection_object.dest.dbname ? connection_object.dest.dbname : "postgres"
    );
    ...
    data.append(
      "dbname",
      connection_object.dbname ? connection_object.dbname : "postgres"
    );
